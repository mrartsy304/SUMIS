...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (user?.role && ROLE_DASHBOARDS[user.role]) {
    ...
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        ...
        <div style={styles.placeholder}>
          ...
          <p style={styles.placeholderText}>Redirecting to your dashboard…</p>
        </div>
      </main>
    </div>
  );
...
const styles = {
  ...
  placeholderText: { margin: 0, color: "#475569", fontSize: 15, fontFamily: "'Georgia', serif" },
};
